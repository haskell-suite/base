...
sIZEOF_StgArrWords_NoHdr dflags = pc_SIZEOF_StgArrWords_NoHdr (sPlatformConstants (settings dflags))
...
mAX_SSE_REG :: DynFlags -> Int
mAX_SSE_REG dflags = pc_MAX_SSE_REG (sPlatformConstants (settings dflags))
...
mAX_Real_SSE_REG :: DynFlags -> Int
mAX_Real_SSE_REG dflags = pc_MAX_Real_SSE_REG (sPlatformConstants (settings dflags))
